...
class NotaController extends Controller
{
    ...
    {
        $nota = App\Http\Controllers\NotaController::findOrFail($id);
    ...
    {
        $notaUpdate = App\Http\Controllers\NotaController::findOrFail($id);
    ...
    {
        $notaDestroy = App\Http\Controllers\NotaController::findOrFail($id);
        $notaDestroy->delete();
