...
<header>
        ...
        <H2>Método de resolución</H2>

        <br>
        <br>

        <p>El método de Gauss-Jordan utiliza operaciones con matrices para resolver sistemas de ecuaciones de n número de variables.</p>

        <br>
        <br>

        <p>Para aplicar este método solo hay que recordar que cada operación que se realice se aplicará a toda la fila o a toda la columna en su caso.</p>

        <br>
        <br>

        <p>El objetivo de este método es tratar de convertir la parte de la matriz donde están los coeficientes de las variables en una matriz identidad. Esto se logra mediante simples operaciones de suma, resta y multiplicación.</p>
